...
<input type='hidden' value="<?php echo $liste;?>" id="hiddenindex">
...
<tbody>
	<tr>
<td><div class="item" id="item-1"><?php echo __("Community");?><div></td>
<td>
...
<tr>
<td><div class="item" id="item-2"><?php echo __("Municipal");?></div></td>
<td>
...
<tr>
<td><div class="item" id="item-3"><?php echo __("Provincial Government");?></div></td>
<td>
...
<tr>
<td><div class="item" id="item-4"><?php echo __("Federal government");?></div></td>
<td>
...
<tr>
<td><div class="item" id="item-5"><?php echo __("Private");?></div></td>
<td>
...
<thead>
<TD><div class="item" id="item-6"><?php echo __("SUB TOTAL"); ?></div></TD>
<TD>  <div class="input-group ng-scope" style="margin-top: 4px;width: 140px;"><span class="input-group-addon addon-left input-group-addon-success">$</span>
	<input style="color:#000000;" id="subtotalcash1" disabled = 'disabled' type="number" class="form-control with-success-addon" id="input1-2" placeholder="00">
	 <span class="input-group-addon addon-right input-group-addon-success">.00</span></div></TD>
<TD>  <div class="input-group ng-scope" style="margin-top: 4px;width: 140px;"><span class="input-group-addon addon-left input-group-addon-success">$</span>
	<input disabled ='disabled' id="subtotalcash2" type="number" style="color:#000000;" class="form-control with-success-addon" id="1-2" placeholder="00"> 
	<span class="input-group-addon addon-right input-group-addon-success">.00</span></div></TD>
...
<div class="input-group ng-scope" style="margin-top: 4px;width: 280px;"><span class="input-group-addon addon-left input-group-addon-success">$</span>
	<input disabled ='disabled' id="total" type="number" style="color:#000000;" class="form-control with-success-addon" id="input1-2" placeholder="00"> 

...
$data=array(
	'Event'=>array(
				explode('=',$liste[0])[0]=>explode('=',$liste[0])[1],
				explode('=',$liste[1])[0]=>explode('=',$liste[1])[1],
				explode('=',$liste[2])[0]=>explode('=',$liste[2])[1],
				explode('=',$liste[3])[0]=>explode('=',$liste[3])[1],
				),
...
{
	$this->loadModel('TypePlan');
	return $this->TypePlan->find('all',['conditions'=>['TypePlan.plan_id'=>$id],'order'=>['TypePlan.position'=>'ASC']])['TypePlan'];
} 
